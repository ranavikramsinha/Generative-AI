...
def classify_message(state: State):
    ...
    is_coding_question = structured_response.choices[0].message.parsed.is_coding_question
...
def coding_validate_query(state: State):
    ...
    SYSTEM_PROMPT = f"""
        You are expert in  calculating accuracy of the code according to the question. Return the percentage of acccuracy.
